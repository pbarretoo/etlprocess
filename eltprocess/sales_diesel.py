...
# df = 0
# for num in range(2013, 2021):
#     if num == 2013:
#         _ = pd.read_excel('vendas_diesel.xls', sheet_name= f'p{num}')
#         df = _
#         # print(df)
...
# df9 = df9.to_csv('sales_of_diesel.csv',header=None, index=False, encoding='utf-8',sep=',')
# # print(df9)
# # my_file = open('sales_of_diesel.csv')
...
my_file = open('sales_of_diesel.csv',encoding='utf-8')
# print(my_file)
